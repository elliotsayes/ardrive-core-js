...
const tag_assertions_1 = __importDefault(require("./arfs/tags/tag_assertions"));
class WalletDAO {
    constructor(arweave, appName = constants_1.DEFAULT_APP_NAME, appVersion = constants_1.DEFAULT_APP_VERSION) {
    ...
    sendARToAddress(arAmount, fromWallet, toAddress, rewardSettings = {}, dryRun = false, [{ value: appName = this.appName }, { value: appVersion = this.appVersion }, { value: txType = 'transfer' }, ...otherTags], assertBalance = false) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const transaction = yield this.arweave.createTransaction(txAttributes, jwkWallet.getPrivateKey());
            ...
            tag_assertions_1.default(transaction.tags);
            // Sign file
            ...
            if (response.status === 200 || response.status === 202) {
                return Promise.resolve({
                    txID: types_1.TxID(transaction.id),
                    winston,
