...
class ArFSFolderBuilder extends arfs_builders_1.ArFSFileOrFolderBuilder {
    constructor() {
        super(...arguments);
        this.protectedDataJsonKeys = ['name'];
    }
...
class ArFSPublicFolderBuilder extends ArFSFolderBuilder {
    static fromArweaveNode(node, gatewayApi) {
        ...
        const folderBuilder = new ArFSPublicFolderBuilder({ entityId: types_1.EID(folderId), gatewayApi });
    ...
    buildEntity() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (((_a = this.appName) === null || _a === void 0 ? void 0 : _a.length) &&
                ...
                return Promise.resolve(new arfs_entities_1.ArFSPublicFolder(this.appName, this.appVersion, this.arFS, this.contentType, this.driveId, this.name, this.txId, this.unixTime, this.parentFolderId, this.entityId, this.boost, this.customMetaData.metaDataGqlTags, this.customMetaData.metaDataJson));
            }
...
class ArFSPrivateFolderBuilder extends ArFSFolderBuilder {
    constructor(folderId, gatewayApi, driveKey, owner) {
    ...
    static fromArweaveNode(node, gatewayApi, driveKey) {
        ...
        const folderBuilder = new ArFSPrivateFolderBuilder(types_1.EID(folderId), gatewayApi, driveKey);
        return folderBuilder;
    }
    parseFromArweaveNode(node) {
        const _super = Object.create(null, {
    ...
    buildEntity() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (((_a = this.appName) === null || _a === void 0 ? void 0 : _a.length) &&
                ...
                return new arfs_entities_1.ArFSPrivateFolder(this.appName, this.appVersion, this.arFS, this.contentType, this.driveId, this.name, this.txId, this.unixTime, this.parentFolderId, this.entityId, this.cipher, this.cipherIV, this.driveKey, this.boost, this.customMetaData.metaDataGqlTags, this.customMetaData.metaDataJson);
            }
