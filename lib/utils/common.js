...
exports.encryptedDataSize = exports.urlEncodeHashKey = exports.gatewayUrlForArweave = exports.fetchMempool = exports.readJWKFile = exports.encryptFileOrFolderData = exports.winstonToAr = exports.sanitizePath = exports.weightedRandom = exports.Utf8ArrayToStr = exports.createPublicDriveSharingLink = exports.createPublicFileSharingLink = exports.createPrivateFileSharingLink = exports.backupWallet = exports.checkExactFileExistsSync = exports.checkFileExistsSync = exports.checkFolderExistsSync = exports.checkOrCreateFolder = exports.moveFolder = exports.extToMime = exports.formatBytes = exports.sleep = void 0;
// index.js
...
function createPrivateFileSharingLink(user, fileToShare) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            fileSharingUrl = constants_1.stagingAppUrl.concat('/#/file/', fileToShare.fileId, '/view?fileKey=', fileKey.keyData.toString('base64'));
        }
        catch (err) {
            console.log(err);
...
function fetchMempool(gateway = new URL(constants_1.defaultArweaveGatewayPath)) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield axios_1.default.get(`${gateway.href}tx/pending`);
        return response.data;
    });
}
exports.fetchMempool = fetchMempool;
/** Derives gateway URL from provided Arweave instance */
function gatewayUrlForArweave(arweave) {
    var _a, _b;
    const protocol = (_a = arweave.api.config.protocol) !== null && _a !== void 0 ? _a : constants_1.defaultGatewayProtocol;
    const host = (_b = arweave.api.config.host) !== null && _b !== void 0 ? _b : constants_1.defaultGatewayHost;
    const portStr = arweave.api.config.port ? `:${arweave.api.config.port}` : '';
    return new URL(`${protocol}://${host}${portStr}/`);
}
exports.gatewayUrlForArweave = gatewayUrlForArweave;
...
function encryptedDataSize(dataSize) {
    if (+dataSize > Number.MAX_SAFE_INTEGER - constants_1.authTagLength) {
        throw new Error(`Max un-encrypted dataSize allowed is ${Number.MAX_SAFE_INTEGER - constants_1.authTagLength}!`);
    }
    return new types_1.ByteCount((+dataSize / constants_1.authTagLength + 1) * constants_1.authTagLength);
}
exports.encryptedDataSize = encryptedDataSize;
