...
function deriveDriveKey(dataEncryptionKey, driveId, walletPrivateKey) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new types_1.EntityKey(driveKey);
    });
}
...
function deriveFileKey(fileId, driveKey) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const fileKey = futoin_hkdf_1.default(driveKey.keyData, keyByteLength, { info, hash: keyHash });
        return new types_1.EntityKey(fileKey);
    });
}
...
function driveEncrypt(driveKey, data) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const cipher = crypto.createCipheriv(algo, driveKey.keyData, iv, { authTagLength: constants_1.authTagLength });
...
function fileEncrypt(fileKey, data) {
    return __awaiter(this, void 0, void 0, function* () {
        const iv = crypto.randomBytes(12);
        const cipher = crypto.createCipheriv(algo, fileKey.keyData, iv, { authTagLength: constants_1.authTagLength });
...
function driveDecrypt(cipherIV, driveKey, data) {
    return __awaiter(this, void 0, void 0, function* () {
        const authTag = data.slice(data.byteLength - constants_1.authTagLength, data.byteLength);
        const encryptedDataSlice = data.slice(0, data.byteLength - constants_1.authTagLength);
        const iv = Buffer.from(cipherIV, 'base64');
        const decipher = crypto.createDecipheriv(algo, driveKey.keyData, iv, { authTagLength: constants_1.authTagLength });
...
function fileDecrypt(cipherIV, fileKey, data) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const encryptedDataSlice = data.slice(0, data.byteLength - constants_1.authTagLength);
            const iv = Buffer.from(cipherIV, 'base64');
            const decipher = crypto.createDecipheriv(algo, fileKey.keyData, iv, { authTagLength: constants_1.authTagLength });
            decipher.setAuthTag(authTag);
