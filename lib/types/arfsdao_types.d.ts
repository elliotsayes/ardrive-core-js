...
import { ArFSObjectMetadataPrototype, CreateDriveMetaDataFactory, ArFSFolderMetaDataPrototype, ArFSDriveMetaDataPrototype, ArFSFolderTransactionData, ArFSPublicFolderTransactionData, ArFSPrivateFolderTransactionData, PrivateDriveKeyData, ArFSFileOrFolderEntity, ArFSObjectTransactionData, ArFSDataToUpload, WithDriveKey, ArFSPublicFile, ArFSPrivateFile, ArFSFileDataPrototype, ArFSFileMetaDataPrototype, FileKey, DriveKey, FolderHierarchy, ArFSPublicFolder, ArFSPrivateFolder, ArFSPublicDrive, ArFSPrivateDrive, ArFSPrivateFileWithPaths, ArFSPrivateFolderWithPaths, ArFSFileToUpload } from '../exports';
...
export declare type PrepareArFSObject<T, U extends ArFSObjectMetadataPrototype> = (metaDataPrototype: U) => Promise<T>;
...
export interface ArFSPrepareFileParams<T = DataItem | Transaction, U = DataItem | Transaction> extends PartialPrepareFileParams {
...
export declare type ArFSPublicCreateFolderParams = ArFSCreateFolderParams<ArFSPublicFolderTransactionData>;
export declare type ArFSPrivateCreateFolderParams = ArFSCreateFolderParams<ArFSPrivateFolderTransactionData>;
...
export declare type ArFSTxResult<R> = {
    result: R;
    transactions: Transaction[];
};
/** Generic parameters for move file and move folder ArFSDAO methods */
export interface ArFSMoveParams<O extends ArFSFileOrFolderEntity<'file' | 'folder'>, T extends ArFSObjectTransactionData> {
    originalMetaData: O;
...
export declare type ArFSUploadPrivateFileParams = ArFSUploadPublicFileParams & WithDriveKey;
...
export interface ArFSListPublicFolderParams {
    ...
    withKeys?: boolean;
    withPathsFactory?: (entity: ArFSPrivateFile | ArFSPrivateFolder, hierarchy: FolderHierarchy, driveKey: DriveKey) => ArFSPrivateFolderWithPaths | ArFSPrivateFileWithPaths;
}
export declare type ArFSListPrivateFolderParams = ArFSListPublicFolderParams & WithDriveKey;
...
export declare type ArFSGetPrivateChildFolderIdsParams = ArFSGetPublicChildFolderIdsParams & WithDriveKey;
export interface ArFSRenamePublicFileParams {
    file: ArFSPublicFile;
    newName: string;
    metadataRewardSettings: RewardSettings;
}
export declare type ArFSRenamePrivateFileParams = ArFSRenamePublicFileParams & WithDriveKey & {
...
export declare type ArFSRenamePrivateFolderParams = ArFSRenamePublicFolderParams & WithDriveKey & {
...
export declare type ArFSRenamePrivateDriveParams = ArFSRenamePublicDriveParams & WithDriveKey & {
    drive: ArFSPrivateDrive;
};
export declare type CommunityTipSettings = {
