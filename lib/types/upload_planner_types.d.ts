...
import { ArFSDriveMetaDataPrototype, ArFSFileMetaDataPrototype, ArFSFolderMetaDataPrototype } from '../arfs/tx/arfs_prototypes';
...
export declare type BundlePackerFactory = () => BundlePacker;
...
export declare type CreateDrivePlan = CreateDriveV2Plan | CreateDriveBundlePlan;
export declare function isBundlePlan(plan: CreateDrivePlan): plan is CreateDriveBundlePlan;
...
export declare type UploadFileRewardSettings = UploadFileV2TxRewardSettings | BundleRewardSettings;
...
export declare const emptyV2TxPlans: {
    fileAndMetaDataPlans: any[];
    fileDataOnlyPlans: any[];
    folderMetaDataPlans: any[];
};
...
export interface CalculatedFileAndMetaDataPlan extends Omit<V2FileAndMetaDataPlan, 'fileDataByteCount' | 'metaDataByteCount'> {
    dataTxRewardSettings: RewardSettings;
    metaDataRewardSettings: RewardSettings;
    communityTipSettings: CommunityTipSettings;
}
...
export declare type PlanFileParams = FileUploadStats & PlanEntityParams;
export declare type PlanFolderParams = FolderUploadStats & PlanEntityParams;
